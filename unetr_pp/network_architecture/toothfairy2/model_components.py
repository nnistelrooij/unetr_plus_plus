...
from unetr_pp.network_architecture.toothfairy2.transformerblock import TransformerBlock
...
class UnetrPPEncoder(nn.Module):
    def __init__(self, input_size=[40 * 40 * 40, 20 * 20 * 20, 10 * 10 * 10, 5 * 5 * 5],dims=[32, 64, 128, 256],
